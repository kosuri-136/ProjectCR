    ...
    <DefaultLayout>
      ...
      >
        <Col lg={10} sm={24} xs={24}>
          <img src={car.image} alt={car.name} className="carimg2 bs2" style={{height:"180px" ,width:"240px"}} />
        </Col>
        <Col
          lg={10}
          sm={24}
              ...
              {from && to && (
                ...
                >
                  ...
                  <StripeCheckout
                    ...
                    stripeKey="pk_test_51NGGovSBxnGg6S0sI1sH6cWmOX6YWG2mj5C2ecPU1leLtzkJ7rJJ9Gu3PvgbkkmZ1mEgSZXEXFgSUZ2ePRBnkwMH004knOkpWf"
                  >
                    <button
                      className="btn1"
                      style={{
