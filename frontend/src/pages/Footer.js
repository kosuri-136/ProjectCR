            ...
            <div className="row">
              <div className="col-xl-4 col-md-4 mb-30">
                <div className="single-cta">
                  <div className="cta-text">
                    ...
                    <h4>Find us</h4>
                    <span>
                      Shop Number 136, Monica center, Madanapalle town
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="col-xl-4 col-md-4 mb-30">
                ...
                <div className="single-cta">
                  <div className="cta-text">
                    <h4>Mail us</h4>
                    <span>kosuriravikanth2@gmail.com</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="col-xl-4 col-lg-4 mb-50">
                <div className="footer-widget">
                  ...
                  <div className="footer-text">
                    <p>
                    "King Kos Cars" The best Car Rental service  and have brances all over the state,User Friendly and have nice ratings from users .
