...
const Chatwidget = () => {
  ...
  useEffect(() => {
    addResponseMessage(
      `Welcome ${user.username}, I'm kosuri 🤖🖐️ a bot. How can i help you today?`
    );
  }, []);
  const handleNewUserMessage = (newMessage) => {
    ...
    if (
      ...
      addResponseMessage(`I'm kosuri the bot`);
    } else if (
      ...
      addResponseMessage(
        `Sorry, I'm currently learning your language. I don't know the answer. Please contact on this number +91 700100003.`
      );
    }
  };
  return (
